...
function headerHtml(path) {
  ...
  <header class="site-header">
    <div class="wrap header-inner">
      <a class="logo" href="/">
        <span class="logo-mark" aria-hidden="true">${icon("paw")}</span>
      ...
      <div class="foot-grid">
        <div class="foot-brand">
          ...
          <p class="foot-contact">
            ${icon("mail")}
            <a href="#" class="js-mail" data-correo="hola|mascotaideal.es">activar JavaScript para ver el correo</a>
          </p>
        </div>
        ${columnas}
      </div>
...
function pageHero({ eyebrow, title, dek, updated, img, imgAlt }) {
  return `<section class="page-hero">
    <div class="wrap${img ? " page-hero-with-img" : ""}">
...
function ctaBand() {
  return `<section class="cta-band">
    <div class="wrap">
      ...
      <p>Empieza por la guía del accesorio que más te preocupe ahora mismo: arnés, comedero automático o cama para tu perro o gato.</p>
